...
export function MobileInputField({ label, placeHolder, onChangeText, value }) {
    ...
    return (
        ...
        <View style={styleSheet.inputGroup}>
            ...
            <TextInput placeholder={placeHolder} maxLength={10} inputMode={"tel"} style={styleSheet.inputFiled} numberOfLines={1} cursorColor={"red"} onChangeText={onChangeText} value={value} />
        </View>
