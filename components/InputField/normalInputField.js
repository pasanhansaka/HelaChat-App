...
export function NormalInputField({ label, placeHolder, onChangeText, value }) {
    ...
    return (
        ...
        <View style={styleSheet.inputGroup}>
            ...
            <TextInput placeholder={placeHolder} style={styleSheet.inputFiled} numberOfLines={1} cursorColor={"red"} onChangeText={onChangeText} value={value} />
        </View>
